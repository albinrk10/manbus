<form id="form-vehiculosn">
    ...
    <div class="row">
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" placeholder="" name="denominacion_comercial" id="denominacion_comercial" />
        </div>
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" placeholder="" name="altura" id="altura" />
        </div>
        <div class="form-group col-md-2">
            <label>Anchura<span class="text-danger">*</span></label>
            <input type="text" class="form-control" placeholder="" name="anchura" id="anchura" />
        </div>

        <div class="form-group col-md-2">
            <label>Longitud<span class="text-danger">*</span></label>
            <input type="text" class="form-control" placeholder="" name="longitud" id="longitud" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" placeholder="" name="tipo_motor" id="tipo_motor" />
        </div>
        <div class="form-group col-md-2">
            <label>N° Cilindros<span class="text-danger">*</span></label>
            <input type="text" class="form-control" placeholder="" name="numero_cilindros" id="numero_cilindros" />
        </div>

        <div class="form-group col-md-3">
            <label> Potencia en CV<span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="potencia_expresada_en_cv" id="potencia_expresada_en_cv" />
        </div>
        <div class="form-group col-md-3">
            <label>Potencia en KW<span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="potencia_expresada_en_kw" id="potencia_expresada_en_kw" />
        </div>
        <div class="form-group col-md-2">
            <label>N° Bastidor<span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="numero_bastidor" id="numero_bastidor" />
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" name="numero_plazas" id="numero_plazas" />
        </div>
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" name="incripcion" id="incripcion" />
        </div>
        <div class="form-group col-md-3">
            <label>Configuracion Vehicular<span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="config_vehicular" id="config_vehicular" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <div class="col-3">
                <span class="switch switch-icon">
                    <label>
                        <input type="checkbox" name="flg_inspeccion_tecnica" id="flg_inspeccion_tecnica" />
                        <span></span>
                    </label>
                </span>
            </div>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="col-3">
                <span class="switch switch-icon">
                    <label>
                        <input type="checkbox" name="flg_soat" id="flg_soat" />
                        <span></span>
                    </label>
                </span>
            </div>
