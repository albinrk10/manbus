<form id="form-perfil">
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Ingrese nombre del rol" name="nombre" id="nombre"/>
    </div>
    <div class="form-group">
            ...
            <?php foreach ($modulo as $m): ?>
                ...
                <div class="col-3">
                    <span class="switch switch-icon">
                        <label>
                            <input type="checkbox" name="modulo[]" value="<?= $m->id_modulo ?>" id="modulo"/>
                            <span></span>
                        </label>
                    </span>
                </div>
